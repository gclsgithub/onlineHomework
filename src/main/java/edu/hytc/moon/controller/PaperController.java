...
import edu.hytc.moon.domain.PapIdQuesCourse;
...
public class PaperController {
    ...
    public String RandomADDQuestion(@PathVariable ("id") Integer papid,String questionCourse,int QuesNums){
        ...
        List<String> questionCourseList =new ArrayList<>();
        if ("all".equalsIgnoreCase(questionCourse)){
            questionCourseList.add("all");
            questionCourseList.add("java");
            questionCourseList.add("c");
            questionCourseList.add("c++");
            questionCourseList.add("python");
            questionCourseList.add("c#");
            questionCourseList.add("go");
            questionCourseList.add("kotlin");
        } else {
            questionCourseList.add(questionCourse);
        }

        papIdQuesCourse.setPapid(papid);
        papIdQuesCourse.setQuestionCourse(questionCourseList);
